...
while selection==False:
	try:
 		...
 		genre = agi.get_variable("genre")
   		...
   		tracks = client.get('/tracks', genres=searchVar, limit=page_size, filter='streamable',offset=page_size*offset)
   ...
   #answer=int(agi.get_variable('selection'))
   		...
   		#agi.appexec('Background', 'custom/track-instructions, any')
