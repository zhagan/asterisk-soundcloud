...
while selection==False:
	try:
 		...
 		genre = agi.get_variable("genre")
   		searchVar = agi.get_variable('userid')
   		tracks = client.get('/users/'+str(searchVar)+'/tracks',limit=page_size,offset=page_size*offset)
   ...
   #answer=int(agi.get_variable('selection'))
   		#agi.appexec('Background', 'custom/track-instructions')
